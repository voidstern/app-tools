...
public enum FileMonitorChangeType {
    case modified
    case metadata
    case size
    case renamed
...
public protocol FileMonitorDelegate {
...
public class FileMonitor {
    ...
    public init(url: URL, delegate: FileMonitorDelegate) {
        self.fileURL = url
    ...
    @discardableResult public func beginMonitoringFile() -> Bool {
