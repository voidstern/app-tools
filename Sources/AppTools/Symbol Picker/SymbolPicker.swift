...
public struct SymbolPicker: View {
    ...
    public init(symbol: Binding<String>, useNavigationStack: Bool = true) {
        self.init(
            symbol: Binding {
            ...
            nullable: false, useNavigationStack: useNavigationStack)
    }
    ...
    public init(symbol: Binding<String?>, useNavigationStack: Bool = true) {
        self.init(symbol: symbol, nullable: true, useNavigationStack: useNavigationStack)
    }

    /// Private designated initializer.
    private init(symbol: Binding<String?>, nullable: Bool, useNavigationStack: Bool = true) {
        self._symbol = symbol
    ...
    private var symbolGrid: some View {
        ScrollView {
            ...
            LazyVGrid(columns: [GridItem(.adaptive(minimum: Self.gridDimension, maximum: Self.gridDimension * 2))]) {
    ...
    private var deleteButton: some View {
        Button(role: .destructive) {
            ...
            Label(L10n.removeSymbol, systemImage: "trash")
                #if !os(tvOS) && !os(macOS)
